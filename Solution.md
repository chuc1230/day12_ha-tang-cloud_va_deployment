# Day 12 Lab - Solution (Đáp án Codelab 1 -> 5)
** Họ và tên:** Đặng Minh Chức - 2A202600611
** Lớp:** C401 
## Part 1: Localhost vs Production

### Exercise 1.1: Anti-patterns found (Các lỗi thiết kế cơ bản)
...
| Feature | Develop | Production | Why Important? (Tầm quan trọng) |
|---------|---------|------------|----------------|
...
### Exercise 2.4: Architecture Diagram (Sơ đồ kiến trúc)
...
- **Public URL:** `https://day12-agent-production.up.railway.app` (Đường dẫn ví dụ)
